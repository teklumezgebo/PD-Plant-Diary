    ...
    return (
        <div className="flex">
            <div className={`bg-[#A5A58D] h-screen p-5 pt-8 ${open ? "w-72" : "w-20"} duration-300 relative`}>
                ...
                <ul className="pt-2">
                    <li className="text-black text-sm flex items-center gap-x-4 cursor-pointer p-2 hover:bg-[#FFE8D6] rounded-md mt-2"><span className="text-2xl block float-left"><MdSpaceDashboard/></span><span className={`text-base font-medium flex-1 duration-200 ${!open && "hidden"}`}>Dashboard</span></li>
